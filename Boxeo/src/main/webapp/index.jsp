        ...
        <div class="contenido">
            ...
            <div class="container">
				...
				<sql:setDataSource var="dbSource" driver="com.mysql.cj.jdbc.Driver"
					...
					<c:if test="${not empty param.Nombre and not empty param.Email and not empty param.Comentario}">
			            <sql:update dataSource="${dbSource}">
			                INSERT INTO comentario (comentario_usuario, comentario_email, comentario_descripcion) 
			                VALUES (?, ?, ?);
			                <sql:param value="${param.Nombre}" />
			                <sql:param value="${param.Email}" />
			                <sql:param value="${param.Comentario}" />
			            </sql:update>
			            <% pageContext.setAttribute("message", "Comentario agregado correctamente."); %>
			        </c:if>
